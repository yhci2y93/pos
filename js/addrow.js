...
function addrow(){
    ...
    var goods_info=[{type:'饮料',name:'可口可乐',count:'3',unit:'瓶'},{type:'饮料',name:'雪碧',count:'3',unit:'瓶'},{type:'水果',name:'苹果',count:'5.5',unit:'斤'},{type:'水果',name:'荔枝',count:'15',unit:'斤'},{type:'生活用品',name:'电池',count:'2',unit:'个'},{type:'食品',name:'方便面',count:'4.5',unit:'袋'}];
    if(replace==1){
